...
class _MusicLibraryViewState extends State<MusicLibraryView>
  ...
  void initState() {
    ...
    _subTabController = TabController(
      length: 6, 
      vsync: this,
      initialIndex: _getInitialTabIndex(viewModel.mode),
    );
  ...
  int _getInitialTabIndex(LibraryMode mode) {
    switch (mode) {
      case LibraryMode.folders: return 0;
      case LibraryMode.artists: return 1;
      case LibraryMode.albums: return 2;
  ...
  void _onScroll() {
    if (_scrollController.hasClients) {
      context.read<LibraryViewModel>().saveScrollOffset(_scrollController.offset);
    }
  }
