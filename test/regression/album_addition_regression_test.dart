...
void main() {
  ...
  group('Queue Regression: Album Addition', () {
    test('Adding an album to queue and skipping should work correctly', () async {
      final trackA = Track(id: '1', path: 'a.mp3', title: 'Song A', artistId: '1', albumId: '1', folderId: '1', rating: 0, isFavorite: false, playCount: 0, isAudiobook: false, isPlayed: false);
      final track1 = Track(id: '2', path: '1.mp3', title: 'Song 1', artistId: '1', albumId: '2', folderId: '1', rating: 0, isFavorite: false, playCount: 0, isAudiobook: false, isPlayed: false);
      final track2 = Track(id: '3', path: '2.mp3', title: 'Song 2', artistId: '1', albumId: '2', folderId: '1', rating: 0, isFavorite: false, playCount: 0, isAudiobook: false, isPlayed: false);
